...
What is RPS?
=====
Given a set <span>&Theta;</span>, we know that its power set considers all combinations of elements in $\Theta$. How about if we consider all permutations of elements in $\Theta$?
